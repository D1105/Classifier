...
def accuracy_for_classes(net, testloader):
    ...
    correct_pred = {classname: 0 for classname in classifier.classes}
    total_pred = {classname: 0 for classname in classifier.classes}
    ...
    with torch.no_grad():
        for data in testloader:
            ...
            for label, prediction in zip(labels, predictions):
                if label == prediction:
                    correct_pred[classifier.classes[label]] += 1
